...
public class Method_Declaration
{
     ...
     */
    public Method_Declaration(Type newType, Identifier newIdentifier, Parameter_List newParameters, Statement newStatement)
    {
    ...
    public void call(List<Object> inputs, SymbolTable parentSymTab) throws Exception {
        SymbolTable symTab = new SymbolTable();
        if (parentSymTab != null) {
            symTab.setParent(parentSymTab);
        }
