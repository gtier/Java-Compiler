...
public class Identifier
{
    ...
    public Identifier(String newIdentifier) throws Exception
    {
        ...
        stringSpace = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890";
    ...
    private String checkIfValid(String str) throws Exception {
        for(int i = 0; i<str.length(); i++) {
            ...
            if (i ==0) {
                ...
                for(int x = 0; x<stringSpace.length(); x++) {
                    if (str.charAt(i) == stringSpace.charAt(x)) {
                        inSet = 1;
                    }
                }
            }
