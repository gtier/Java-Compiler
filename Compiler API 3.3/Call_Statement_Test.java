...
import java.util.*;
/**
 * The test class Call_StatementTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class Call_Statement_Test
{
    /**
     * Default constructor for test class Call_StatementTest
     */
    public Call_Statement_Test()
    {
    }
    ...
    @Test
    public void call_method_and_return()
    {
        try {
            ...
            List<Expression> callList = new ArrayList();
            callList.add(new Numerical_Expression(new Double(2.0)));
            Call_Statement callFunc = new Call_Statement(callList, "square", "toReturn");
            callFunc.setParent(symTab);
