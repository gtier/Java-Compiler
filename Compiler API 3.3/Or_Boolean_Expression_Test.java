...
/**
 * The test class Or_Boolean_ExpressionTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class Or_Boolean_Expression_Test
{
    /**
     * Default constructor for test class Or_Boolean_ExpressionTest
     */
    public Or_Boolean_Expression_Test()
    {
    ...
    public void evaluate()
    {
        ...
        Or_Boolean_Expression or_bool_1 = new Or_Boolean_Expression(boolean_9, boolean_8);
        Boolean evalBool_1 = or_bool_1.evaluate(null);
        assertNotNull(evalBool_1);
        assertEquals(true, evalBool_1.booleanValue());
        
        Or_Boolean_Expression or_bool_2 = new Or_Boolean_Expression(boolean_8, boolean_6);
        Boolean evalBool_2 = or_bool_2.evaluate(null);
