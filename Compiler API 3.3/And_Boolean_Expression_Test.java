...
/**
 * The test class And_Boolean_ExpressionTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class And_Boolean_Expression_Test
{
    /**
     * Default constructor for test class And_Boolean_ExpressionTest
     */
    public And_Boolean_Expression_Test()
    {
    }
    ...
    public void evaluate()
    {
        ...
        And_Boolean_Expression and_bool_1 = new And_Boolean_Expression(boolean_9, boolean_8);
        Boolean evalBool_1 = and_bool_1.evaluate(null);
        assertNotNull(evalBool_1);
        assertEquals(false, evalBool_1.booleanValue());
        
        And_Boolean_Expression and_bool_2 = new And_Boolean_Expression(boolean_8, boolean_6);
        Boolean evalBool_2 = and_bool_2.evaluate(null);
        assertNotNull(evalBool_2);
        assertEquals(false, evalBool_2.booleanValue());
        
        And_Boolean_Expression and_bool_3 = new And_Boolean_Expression(boolean_5, boolean_4);
        Boolean evalBool_3 = and_bool_3.evaluate(null);
        assertNotNull(evalBool_3);
        assertEquals(true, evalBool_3.booleanValue());
